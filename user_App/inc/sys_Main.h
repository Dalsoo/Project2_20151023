...
/* 2015 0925 #define BATT_LED_LEVEL1_OUT         23
#define BATT_LED_LEVEL2_OUT         22
#define BATT_LED_LEVEL3_OUT         21
*/
#define ION_LED4_OUT         22
#define ION_LED3_OUT         21
// NC 													         23
//#define BATT_LED_LEVEL4_OUT          24

#define DUST_STAT_LED_BAD_OUT  24    //29 //24
#define DUST_STAT_LED_MEDIOCRE_OUT   25 //28 //25
#define DUST_STAT_LED_FAIR_OUT   28  //25 //28
#define DUST_STAT_LED_EXCELLENT_OUT  29  //24//29
/* 2015 0925
#define BT_CONNECT_ON_LED                 3
#define BT_CONNECT_OFF_LED                2    */

#define BT_CONNECT_ON_LED                 10
//#define BT_CONNECT_OFF_LED                2

#define ION_LED2_OUT						                 3
#define ION_LED1_OUT							                2
#define POWER_LED_OUT			                     8
#define GREEN_LED_OUT			                     8
...
/**********  s w input  ***********/ 
// 2015 1006
#define ION_ON_SW_IN			20    //15
#define DUST_SW_IN				    15    //20
...
/****  TEST LED *****/
#define ION_LED_OUT_OFF()  {  nrf_gpio_pin_set(ION_LED1_OUT);  nrf_gpio_pin_set(ION_LED2_OUT); nrf_gpio_pin_set(ION_LED3_OUT); nrf_gpio_pin_set(ION_LED4_OUT); }
#define ION_LED_OUT_ON()  { nrf_gpio_pin_clear(ION_LED1_OUT); nrf_gpio_pin_clear(ION_LED2_OUT);nrf_gpio_pin_clear(ION_LED3_OUT);nrf_gpio_pin_clear(ION_LED4_OUT); }
